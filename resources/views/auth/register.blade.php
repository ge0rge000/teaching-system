...
<x-jet-validation-errors class="mb-4" />
            <form class="form-stl" action="{{ route('register') }}" name="frm-login" method="post" >
                ...
                <fieldset class="wrap-input">
                    ...
                    <input type="text" id="frm-reg-lname" name="phone_number" placeholder="mobile*" :value="name" required autofocus autocomplete="name">
                </fieldset>
                <fieldset class="wrap-input">
                    <label for="frm-reg-email">year*</label>
                    <select  class="form-select de" name="year_type">
