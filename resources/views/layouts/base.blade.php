                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                   ...
                   @auth
                    ...
                    <li> 
                      <a class="cd" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit()">logout</a>
  
                    <form id="logout-form" method="POST" action={{ route('logout') }} >
                      @csrf
                    </form>
                  </li>
                  <li > <a class="cd">{{ Auth::user()->name }}</a></li>

                    <li><a class="cd" href="{{ route('admin.dashboard') }}"  >Dashboard</a></li>
                    ...
                    <li><a  class="cd" href="{{route('user.dashboard')}}"  >Dashboard</a></li>
                    
                    @endif
                    @else
                    <li><a class="cd" href="{{ route('register') }}">sing up</a>    </li>       
                      <li> <a class="cd" href="{{ route('login') }}">login</a>   </li>
                    @endif
                    @endif
                  </li>
